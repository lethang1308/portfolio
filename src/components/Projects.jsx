          ...
          {projectsList.map((project) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1 justify-between">
                <div>
                  {project.liveUrl ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="font-display text-lg font-bold text-slate-900 transition-colors hover:text-blue-600 hover:underline"
                    >
                      {project.title}
                    </a>
                  ) : (
                    <h3 className="font-display text-lg font-bold text-slate-900 transition-colors group-hover:text-blue-600">
                      {project.title}
                    </h3>
                  )}
                ...
                {/* Card Links Footer */}
                <div className="mt-6 flex items-center pt-4 border-t border-slate-50">
                  <Link 
